...
DASHSCOPE_API_KEY = getenv("DASHSCOPE_API_KEY")  # optional Alibaba Model Studio key
DASHSCOPE_API_KEYS = getenv("DASHSCOPE_API_KEYS", "")  # optional comma-separated pool
DASHSCOPE_REGION = getenv("DASHSCOPE_REGION", "sg")  # optional: sg/us/cn
